...
const googleMapsLink = "https://www.google.com/maps?q=48.8584,2.2945"; // Reemplaza con tu enlace
...
const locationFlow = addKeyword<Provider, Database>(locationKeywords).addAction(
  async (ctx, { flowDynamic }) => {
    try {
       await flowDynamic([{ body: `Av. Salvador Díaz Mirón #2668, Colonia Electricistas, C.P. 91916, Veracruz, Ver. : ${googleMapsLink}` }]);
